...
\title{
    ...
    [2cm]
    {\scshape Self-driving Car with CARLA Simulator}\\
    [0.4cm]
    {\Large Data Mining and Machine Learning Project}\\
    [3cm]
    \LARGE{\textbf{Supervisors}\hfill\textbf{Candidate}}\\
    \Large{\emph{Prof. Francesco Marcelloni}\hfill\emph{Rambod Rahmani\\}}
    \Large{\emph{Prof. Pietro Ducange}\hfill}
    \vfill
    \date{\today}
}
